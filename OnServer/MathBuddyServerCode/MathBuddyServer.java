...
public class MathBuddyServer {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            DBConnection DB = new DBConnection("mathbuddy.cxhvyitpwnek.us-east-2.rds.amazonaws.com", 3306);  //"localhost", 3306
            while (true) {
                Socket connectionSocket = welcomeSocket.accept();
                BufferedReader inFromClient = new BufferedReader(new InputStreamReader(connectionSocket.getInputStream()));
                String requestType = inFromClient.readLine();
                if(requestType.equals("0")){
                    //means this is a request Type 0
